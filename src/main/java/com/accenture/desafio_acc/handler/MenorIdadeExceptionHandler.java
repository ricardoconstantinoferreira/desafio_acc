...
import com.accenture.desafio_acc.exception.MenorIdadeException;
...
public class MenorIdadeExceptionHandler {

    @ExceptionHandler(MenorIdadeException.class)
    public ResponseEntity<ErroRespostaDto> menorIdade(MenorIdadeException e) {
