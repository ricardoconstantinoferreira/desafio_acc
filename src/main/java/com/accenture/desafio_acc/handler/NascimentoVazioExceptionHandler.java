...
import com.accenture.desafio_acc.exception.NascimentoVazioException;
...
public class NascimentoVazioExceptionHandler {

    @ExceptionHandler(NascimentoVazioException.class)
    public ResponseEntity<ErroRespostaDto> nascimentoVazio(NascimentoVazioException e) {
